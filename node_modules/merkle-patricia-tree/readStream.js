  ...
  _createClass(TrieReadStream, [{
    ...
    value: function _read() {
      ...
      if (!this._started) {
        ...
        this.trie._findValueNodes(function (nodeRef, node, key, depth, next) { // KJ: RESEARCH - added depth
          _this2.push({
            key: TrieNode.nibblesToBuffer(key),
            value: node.type == "extention" ? null : node.value,  // KJ: RESEARCH - added if here (typo is correct)
            node: node,    // KJ: RESEARCH - added Node in the data
            depth: depth    // KJ: RESEARCH - added depth
          });
          next(depth);
        }, function () {
          // close stream
